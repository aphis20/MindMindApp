...
export const metadata: Metadata = {
  title: "Authentication - MindBridge",
  description: "Authentication forms for MindBridge",
};
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "MindBridge has been a transformative experience for me. The support and understanding I've found here have helped me navigate through difficult times."
            </p>
